...
def main():
    ...
    for data in ["cifar10h", "galaxyzoo", "chestxray2", "hatespeech", "synth"]:
        ...
        for method in ["RS", "CC", "DT", "LCE", "SP", "OVA", "ASM"]:
            ...
            for c in target_coverages: #for each target coverage compute the tau_ATT and tau_RDD
            ...
            tmp_res = pd.DataFrame()
            tmp_res["data"] = [data if data != "chestxray2" else "xray-airspace"] #name the dataset xray-airspace for consistency
            tmp_res["method"] = [method]

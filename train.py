...
from src.networks import WideResNet, DenseNet121_CE, LinearNet, LinearNetDefer, NonLinearNet, ResNet50_CE
import os
import argparse
import datetime
...
def load_model_trained(n, path, device, dataset, class_network="Linear"):
    if "chestxray" in dataset:
        ...
        if class_network == "Linear":
            ...
            model_cnn.densenet121.classifier = NonLinearNet(model_cnn.num_ftrs, n).to(device)
...
@track_emissions(project_name="RDD", measure_power_secs=90, api_call_interval=5, output_file="RDD_emissions.csv")
def test(seed=seed, defer_system=defer_system, data=data, data_distribution=data_distribution,
         expert_deferred_error=expert_deferred_error, expert_nondeferred_error=expert_nondeferred_error,
         machine_nondeferred_error=machine_nondeferred_error, d=d,
         num_of_guassians=num_of_guassians, device=device, label_chosen=label_chosen,
         ts=10000, target_coverages=[.10, .20, .30, .40, .50, .60, .70, .80, .90, None]):
    ...
    if data == "synth":
        ...
        path_model = "models/{}/model_{}_{}_{}_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                        expert_deferred_error,
                                                                        expert_nondeferred_error,
                                                                        machine_nondeferred_error, total_epochs)
        path_model_rej = "models/{}/model_rej_{}_{}_{}_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                expert_deferred_error,
                                                                                expert_nondeferred_error,
                                                                                machine_nondeferred_error, total_epochs)
        path_model_class = "models/{}/model_class_{}_{}_{}_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                    expert_deferred_error,
                                                                                    expert_nondeferred_error,
                                                                                    machine_nondeferred_error,
                                                                                    total_epochs)
        path_model_expert = "models/{}/model_expert_{}_{}_{}_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                      expert_deferred_error,
                                                                                      expert_nondeferred_error,
                                                                                      machine_nondeferred_error,
                                                                                      total_epochs)
        ...
        epochs = 10
        bs = 32
        path_model_pre = 'models/chestxray/chextxray_dn121_GC_{}_w1_lb{}_ep{}_bs{}_.pt'.format(seed, label_chosen,epochs, bs)
        ...
        if not os.path.isfile(path_model_pre):
            ...
            lr = 0.0001
            print(label_chosen)
            synth_data = ChestXrayDataset(True, True, data_dir="data", label_chosen=label_chosen, batch_size=bs)
            ...
            SP.fit(synth_data.data_train_loader, synth_data.data_val_loader, synth_data.data_test_loader,
                                epochs=epochs, optimizer=optimizer_linear, lr=lr, verbose=True, test_interval=1,
                                weight=w_classes, m_norm=5)
            sp_metrics = compute_classification_metrics(SP.test(synth_data.data_test_loader))
            print(sp_metrics)
        ...
        lr = 1e-3
        total_epochs = 3 #100
        dataset = ChestXrayDataset(False, True, data_dir="data", label_chosen=label_chosen, batch_size=128,
                                   test_split=.2, val_split=.10)
        n_class = 2
        s_size = 25
        g = 0.5
        ...
        if defer_system in ["RS", "MoE", "LCE", "OVA", "ASM"]:
            # model_base = LinearNet(dataset.d, num_class).to(device)
            model_base = load_model_trained(n_class + 1, path_model_pre, device, data, class_network="NonLinear")
        elif defer_system in ["CC"]:
            model_class = load_model_trained(n_class, path_model_pre, device, data, class_network="NonLinear")
            model_expert = load_model_trained(2, path_model_pre, device, data, class_network="NonLinear")
        elif defer_system == "SP":
            model_base = load_model_trained(n_class, path_model_pre, device, data, class_network="NonLinear")
        elif defer_system == "DT":
            model_class = load_model_trained(n_class, path_model_pre, device, data, class_network="NonLinear")
            model_rejector = load_model_trained(2, path_model_pre, device, data, class_network="NonLinear")
        path_model = "models/{}/densenet121NL_model_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                           total_epochs)
        path_model_rej = "models/{}/densenet121NL_model_rej_{}_{}_{}_ep{}.pt".format(data, data, defer_system,
                                                                                   seed, total_epochs)
        path_model_class = "models/{}/densenet121NL_model_class_{}_{}_{}_ep{}.pt".format(data, data,
                                                                                       defer_system, seed,
                                                                                       total_epochs)
        path_model_expert = "models/{}/densenet121NL_model_expert_{}_{}_{}_ep{}.pt".format(data, data,
                                                                                         defer_system, seed,
                                                                                         total_epochs)
    elif data == "cifar10h":
        ...
        if not os.path.isfile(path_model_pre):
            ...
            sp_metrics = SP.fit(synth_data.data_train_loader, synth_data.data_val_loader, synth_data.data_test_loader,
                                epochs=200, optimizer=optimizer_linear, lr=lr, verbose=True, test_interval=2)
            print(sp_metrics)
            # pickle the state_dict
            torch.save(SP.model_class.state_dict(), path_model_pre)
        set_seed(seed)
        ...
        max_trials = 10
        total_epochs = 150
        dataset = Cifar10h(False, data_dir="data/", batch_size=128, test_split=.2, val_split=.10)
        # instatiate model base
        if defer_system in ["RS", "MoE", "LCE", "OVA", "ASM"]:
            # model_base = LinearNet(dataset.d, num_class).to(device)
            model_base = load_model_trained(n_class + 1, path_model_pre, device, dataset=data)
        elif defer_system in ["CC"]:
            model_class = load_model_trained(n_class, path_model_pre, device, dataset=data)
            model_expert = load_model_trained(2, path_model_pre, device, dataset=data)
        elif defer_system == "SP":
            model_base = load_model_trained(n_class, path_model_pre, device, dataset=data)
        elif defer_system == "DT":
            model_class = load_model_trained(n_class, path_model_pre, device, dataset=data)
            model_rejector = load_model_trained(2, path_model_pre, device, dataset=data)
        path_model = "models/{}/wresenet_model_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                        total_epochs)
        path_model_rej = "models/{}/wresenet_model_rej_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                total_epochs)
        path_model_class = "models/{}/wresenet_model_class_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                    total_epochs)
        path_model_expert = "models/{}/wresenet_model_expert_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                      total_epochs)
        ...
        s_size = 25
        g = 0.5
        dataset = HateSpeech("data/", True, False, 'random_annotator', device, test_split=.2, val_split=.10, batch_size=128)
        n_class = 3
        total_epochs = 100
        w_classes = None
        # instatiate model base
        if defer_system in ["RS", "MoE", "LCE", "OVA", "ASM"]:
            ...
            model_class = LinearNet(dataset.d, n_class).to(device)
            model_rejector = LinearNet(dataset.d, 2).to(device)
        path_model = "models/{}/linear_model_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed, total_epochs)
        path_model_rej = "models/{}/linear_model_rej_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                              total_epochs)
        path_model_class = "models/{}/linear_model_class_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                  total_epochs)
        path_model_expert = "models/{}/linear_model_expert_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                                    total_epochs)
    elif data == "galaxyzoo":
        optimizer = optim.Adam
        scheduler = None
        ...
        s_size = 25
        g = 0.5
        dataset = GalaxyZoo(data_dir="data/", batch_size=128,
                              test_split=.2, val_split=.10)
        n_class = 2
        total_epochs = 50
        w_classes = None
        ...
        path_model = "models/{}/resnet50_model_{}_{}_{}_ep{}.pt".format(data, data, defer_system, seed,
                                                                           total_epochs)
        path_model_rej = "models/{}/resnet50_model_rej_{}_{}_{}_ep{}.pt".format(data, data, defer_system,
                                                                                   seed, total_epochs)
        path_model_class = "models/{}/resnet50_model_class_{}_{}_{}_ep{}.pt".format(data, data,
                                                                                       defer_system, seed,
                                                                                       total_epochs)
        path_model_expert = "models/{}/resnet50_model_expert_{}_{}_{}_ep{}.pt".format(data, data,
                                                                                         defer_system, seed,
                                                                                         total_epochs)
    print_time = False
    if defer_system == "RS":
        ...
        if os.path.exists(path_model):
            ...
            if data != "synth":
                path_model_rs_hp = "models/{}/net_rs_hp_{}_{}_{}_ep{}".format(data, data, defer_system, seed,
                                                                                   total_epochs)
            else:
                path_model_rs_hp = "models/{}/net_rs_hp_{}_{}_{}_{}_{}_{}_ep{}".format(data, data, defer_system,
                                                                                               seed,
                                                                                               expert_deferred_error,
                                                                                               expert_nondeferred_error,
                                                                                               machine_nondeferred_error,
            ...
            if os.path.exists(path_model):
                ...
                if data != "synth":
                    path_model_lce_hp = "models/{}/net_lce_hp_{}_{}_{}_ep{}".format(data, data, defer_system, seed, total_epochs)
                else:
                    path_model_lce_hp = "models/{}/net_lce_hp_{}_{}_{}_{}_{}_{}_ep{}".format(data, data, defer_system, seed,
                                                                                            expert_deferred_error,
                                                                                            expert_nondeferred_error,
                                                                                            machine_nondeferred_error, total_epochs)
                print_time = True
            ...
            if os.path.exists(path_model_class):
                ...
                model.model_class.load_state_dict(torch.load(path_model_class, map_location=device))
                model.model_expert.load_state_dict(torch.load(path_model_expert, map_location=device))
            else:
                print_time = True
                start_time = time.time()
                model.fit(
                ...
                if os.path.exists(path_model_class):
                    ...
                    model.model_rejector.load_state_dict(torch.load(path_model_rej, map_location=device))
                else:
                    if data != "synth":
                        path_model_dt_hp = "models/{}/net_dt_hp_{}_{}_{}_ep{}".format(data, data, defer_system, seed, total_epochs)
                    else:
                        path_model_dt_hp = "models/{}/net_dt_hp_{}_{}_{}_{}_{}_{}_ep{}".format(data, data, defer_system, seed,
                                                                                            expert_deferred_error,
                                                                                            expert_nondeferred_error,
                                                                                            machine_nondeferred_error, total_epochs)
                    print_time = True
    ...
    for target_coverage in target_coverages:
        ...
        correct = np.where(deferred == 1, test_vals['labels'] == test_vals['hum_preds'],
                           test_vals['labels'] == test_vals['preds']).astype(float)
        # main()
        try:
            tmp, res_dict = get_rdd_robust_results(correct, test_vals['rej_score'], cutoff=threshold)
            ...
            if data == "synth":
                tmp['dataset'] = "synth_{}_ExpertError{}_ExpertNDError{}_MachineError{}".format(seed, expert_deferred_error,
                                                                                            expert_nondeferred_error,
                                                                                            machine_nondeferred_error)
            else:
                tmp['dataset'] = data
            ...
            if data != "synth":
                if print_time:
                    ...
                    res.to_csv('results/{}/GCresultsWithTime_test_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed,
                                                                                    total_epochs), index=False)
                else:
                    res.to_csv('results/{}/GCresults_test_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed, total_epochs), index=False)
            else:
                if print_time:
                    res['time_to_fit'] = time_to_fit
                    res.to_csv(
                        'results/{}/GCresultsWithTime_test_{}_{}_{}_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed,
                                                                                      expert_deferred_error,
                                                                                      expert_nondeferred_error,
                                                                                      machine_nondeferred_error,
                                                                                      total_epochs),
                    ...
                    res.to_csv('results/{}/GCresults_test_{}_{}_{}_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed,
                                                                                  expert_deferred_error,
                                                                                  expert_nondeferred_error,
                                                                                  machine_nondeferred_error, total_epochs),
                           index=False)
    ...
    if data == "synth":
        ...
        tmp1.to_csv('resultsRAW/{}/GCresultsRAW_test_{}_{}_{}_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed,
                                                                                      expert_deferred_error,
                                                                                      expert_nondeferred_error,
                                                                                      machine_nondeferred_error,
                                                                                      total_epochs),
                    index=False)
        tmp2.to_csv('resultsRAW/{}/GCresultsRAW_cal_{}_{}_{}_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed,
                                                                                     expert_deferred_error,
                                                                                     expert_nondeferred_error,
                                                                                     machine_nondeferred_error,
                                                                                     total_epochs),
        ...
        if os.path.exists("resultsRAW/{}/".format(data)) is False:
            os.mkdir("resultsRAW/{}/".format(data))
        tmp1.to_csv(
            'resultsRAW/{}/GCresultsRAW_test_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed, total_epochs),
            index=False)
        tmp2.to_csv(
            'resultsRAW/{}/GCresultsRAW_cal_{}_{}_{}_ep{}.csv'.format(data, data, defer_system, seed, total_epochs),
            index=False)
...
if __name__ == "__main__":
    ...
    if defer_system == "all":
        ...
        all_m = False
    main(all_data=all_d, all_models=all_m, seed=seed, defer_system=defer_system, data=data, data_distribution=data_distribution,
         expert_deferred_error=expert_deferred_error, expert_nondeferred_error=expert_nondeferred_error,
         machine_nondeferred_error=machine_nondeferred_error, d=d,
         num_of_guassians=num_of_guassians, device=device)

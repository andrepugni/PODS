...
\midrule
\multirow{10}{*}{\rotatebox[origin=c]{90}{$\htatd$}} & .00 & $-.103~(\textcolor{blue}{\num{5.96e-18}})$ & $-.100~(\textcolor{blue}{\num{2.98e-17}})$ & $-.093~(\textcolor{blue}{\num{1.13e-14}})$ & $\mathbf{-.082~(\textcolor{blue}{\num{3.04e-11}})}$ & $-.098~(\textcolor{blue}{\num{1.89e-16}})$ & $-.099~(\textcolor{blue}{\num{6.63e-17}})$ & $-.097~(\textcolor{blue}{\num{2.81e-15}})$ \\
 & .10 & $-.088~(\textcolor{blue}{\num{5.64e-12}})$ & $-.093~(\textcolor{blue}{\num{1.81e-13}})$ & $-.089~(\textcolor{blue}{\num{1.31e-12}})$ & $\mathbf{-.081~(\textcolor{blue}{\num{3.61e-10}})}$ & $-.086~(\textcolor{blue}{\num{3.07e-11}})$ & $-.098~(\textcolor{blue}{\num{4.17e-14}})$ & $-.096~(\textcolor{blue}{\num{2.81e-15}})$ \\
 & .20 & $-.076~(\textcolor{blue}{\num{1.34e-8}})$ & $-.082~(\textcolor{blue}{\num{8.11e-10}})$ & $-.094~(\textcolor{blue}{\num{1.77e-12}})$ & $-.074~(\textcolor{blue}{\num{6.26e-8}})$ & $\mathbf{-.072~(\textcolor{blue}{\num{2.10e-7}})}$ & $-.092~(\textcolor{blue}{\num{1.16e-10}})$ & $-.096~(\textcolor{blue}{\num{2.81e-15}})$ \\
 & .30 & $-.069~(\textcolor{blue}{\num{1.01e-6}})$ & $-.067~(\textcolor{blue}{\num{5.59e-6}})$ & $-.084~(\textcolor{blue}{\num{1.65e-9}})$ & $-.072~(\textcolor{blue}{\num{6.54e-7}})$ & $\mathbf{-.060~(\num{9.17e-5})}$ & $-.078~(\textcolor{blue}{\num{8.71e-7}})$ & $-.096~(\textcolor{blue}{\num{2.81e-15}})$ \\
 & .40 & $-.063~(\textcolor{blue}{\num{5.98e-5}})$ & $-.060~(\num{2.78e-4})$ & $-.082~(\textcolor{blue}{\num{2.49e-8}})$ & $\mathbf{-.051~(\num{1.24e-3})}$ & $-.057~(\num{5.86e-4})$ & $-.072~(\textcolor{blue}{\num{2.52e-5}})$ & $-.056~(\num{2.04e-3})$ \\
 & .50 & $-.060~(\num{4.09e-4})$ & $-.045~(\num{2.19e-2})$ & $-.090~(\textcolor{blue}{\num{1.13e-8}})$ & $-.039~(\num{3.18e-2})$ & $-.046~(\num{1.62e-2})$ & $-.039~(\num{4.32e-2})$ & $\mathbf{-.039~(\num{6.11e-2})}$ \\
 & .60 & $-.051~(\num{7.96e-3})$ & $-.013~(\num{5.68e-1})$ & $-.100~(\textcolor{blue}{\num{4.39e-8}})$ & $\mathbf{-.006~(\num{7.62e-1})}$ & $-.025~(\num{2.54e-1})$ & $-.006~(\num{7.74e-1})$ & $-.006~(\num{7.88e-1})$ \\
